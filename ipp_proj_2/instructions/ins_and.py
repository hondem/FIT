...
class INS_And(BaseInstruction):
	...
	def eval(self):
		...
		if self.instruction['args']['2']['type'] == 'var':
			...
			symb1 = self.programMemory[varPath[0]][varPath[1]] if self.programMemory[varPath[0]][varPath[1]]['type'] == 'bool' else ErrorHandler.ERROR_SEMANTIC()
		else:
			symb1 = self.instruction['args']['2'] if self.instruction['args']['2']['type'] == 'bool' else ErrorHandler.ERROR_RUNTIME_OPERAND_VALUE()
		...
		if self.instruction['args']['3']['type'] == 'var':
			...
			self.checkVarExistence(self.programMemory, varPath[0], varPath[1])
			symb2 = self.programMemory[varPath[0]][varPath[1]] if self.programMemory[varPath[0]][varPath[1]]['type'] == 'bool' else ErrorHandler.ERROR_SEMANTIC()
		else:
			symb2 = self.instruction['args']['3'] if self.instruction['args']['3']['type'] == 'bool' else ErrorHandler.ERROR_RUNTIME_OPERAND_VALUE()
