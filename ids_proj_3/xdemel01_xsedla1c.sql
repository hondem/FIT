...
-- Zjistí, na kolika fotkách jsou jednotliví uživatelé označeni
...
-- Zjistí, kolika akcí se jednotliví uživatelé zúčastnili
...
-- Zjistí, kolik zpráv v jednotlivých konverzací jednotliví uživatelé napsali
...
-- Zjistí, kteří uživatele jsou někde zaměstnaní
...
-- Kteří uživatele nevytvořili žádný příspěvek
SELECT uzivatel.jmeno, uzivatel.prijmeni
FROM uzivatel
